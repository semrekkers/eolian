...
var allModules = []struct {
	...
	{"Osc", nil, []string{"pitch", "pitchMod", "pitchModAmount", "amp", "detune", "offset", "sync"},
		[]string{"sine", "saw", "pulse", "triangle", "sub"}},
	{"Oscillator", nil, []string{"pitch", "pitchMod", "pitchModAmount", "amp", "detune", "offset", "sync"},
		[]string{"sine", "saw", "pulse", "triangle", "sub"}},
	{"Quantize", Config{"size": 2}, []string{"0.pitch", "1.pitch"}, defaultOutput},
	{"RandomSeries", nil, []string{"clock", "max", "min", "size", "trigger"}, []string{"gate", "values"}},
